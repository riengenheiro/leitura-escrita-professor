...
function getInitialTimeLeft(): number {
  ...
  const saved = localStorage.getItem('le_countdown_end')
  if (saved) {
...
function Countdown() {
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem('le_countdown_end')) {
      const endTime = Math.floor(Date.now() / 1000) + FIFTEEN_MINUTES
      localStorage.setItem('le_countdown_end', endTime.toString())
    }
    ...
    <div className="flex flex-col items-center justify-center gap-3">
      ...
      <div className="flex items-center gap-4">
        <div className="flex flex-col items-center">
          <div className={`relative bg-white rounded-xl shadow-2xl overflow-hidden w-20 h-20 md:w-24 md:h-24 flex items-center justify-center ${isUrgent ? 'animate-pulse border-4 border-red-500' : 'border-4 border-accent'}`}>
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(180deg, #ffffff 0%, #F2F2F2 50%, rgba(29, 143, 242, 0.05) 100%)' }}
      >
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 lg:py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Para professoras de leitura e escrita
              </span>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight mb-6 text-gray-900">
                Cansada de improvisar na hora de observar, registrar e saber o que fazer com a criança que não avança?
              </h1>
              <p className="text-2xl md:text-3xl font-bold mb-6" style={{ color: '#1D8FF2' }}>
                Você não está sozinha!
              </p>
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                Mais de <strong style={{ color: '#1C8C4D' }}>3.300 professoras</strong> já usam os materiais da Dra. Guaciara Fornaciari para organizar observações, sondagens, registros e encaminhamentos com mais clareza.
              </p>
            </div>
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                >
                  <img
                    src="https://fabricamagica.doutoraescola.com.br/images/fabrica-magica/guaciara.webp"
                    alt="Dra. Guaciara Fornaciari - Leitura e Escrita para Professoras"
      ...
      <section className="py-12 relative overflow-hidden" style={{ background: '#F2F2F2' }}>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            Quero organizar minha prática agora!
          </a>
