...
const completoFeatures = [
  'Aula ao vivo com a Dra. Guaciara Fornaciari sobre leitura e escrita',
  { text: '🎁 BÔNUS #1: 5 modelos de Ficha de Observação Individual', bonus: true },
  { text: '🎁 BÔNUS #2: 5 modelos de Questionário de Sondagem Inicial', bonus: true, trophy: true },
  { text: '🎁 BÔNUS #3: 5 modelos de PAEE - Resolução SEDUC Nº 129/2025', bonus: true },
  { text: '🎁 BÔNUS #4: 5 modelos de Guia de Adaptações Curriculares', bonus: true },
  { text: '🎁 BÔNUS #5: 5 modelos de Estudo de Caso - Resolução SEDUC 129/2025', bonus: true },
  { text: '🎁 BÔNUS #6: 5 modelos de Relatório de Desenvolvimento Individual', bonus: true },
  { text: '🎁 BÔNUS #7: 5 modelos de Relatório de Encaminhamento para Especialista', bonus: true },
  { text: '🎁 BÔNUS #8: 5 modelos de Avaliação Pedagógica Inicial - API', bonus: true },
  { text: '✨ 40 modelos prontos para adaptar e usar', special: true },
]

export function LEPricing({ price }: LEPricingProps) {
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <p className="text-center text-xl text-gray-700 mb-12">
          Mais de 3.300 professoras já escolheram. Qual será a sua?
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="rounded-3xl shadow-lg overflow-hidden border-2 bg-white transform transition-all hover:scale-[1.02]" style={{ borderColor: 'rgba(29, 143, 242, 0.4)' }}>
            ...
            <div className="p-8">
              <p className="text-gray-500 text-lg mb-2">Só a aula</p>
              {basicPrice < PRICE_ANCHOR && (
                <p className="text-red-500 line-through text-lg">de: R$ {formatPrice(PRICE_ANCHOR, true)}</p>
              )}
              <div className="flex items-baseline gap-2 mb-8">
                <p className="text-5xl md:text-6xl font-extrabold" style={{ color: '#1C8C4D' }}>R$ {formatPrice(basicPrice)}</p>
              ...
              <div className="rounded-xl p-4 mb-6 border-2" style={{ background: 'rgba(242, 200, 73, 0.12)', borderColor: 'rgba(242, 200, 73, 0.5)' }}>
                <p className="text-sm text-gray-700 text-center font-medium">⚠️ Apenas a aula, sem os 40 modelos bônus</p>
                <p className="text-xs text-gray-500 text-center mt-1">Você vai perder os modelos exclusivos de observação, sondagem e relatórios</p>
              </div>
          ...
          <div className="rounded-3xl shadow-2xl overflow-hidden border-4 bg-white relative transform md:scale-110 transition-all hover:scale-[1.12]" style={{ borderColor: '#1C8C4D' }}>
            ...
            <div className="text-white py-6 px-6 pt-8" style={{ background: 'linear-gradient(135deg, #1C8C4D 0%, #167d44 100%)' }}>
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="font-extrabold text-2xl md:text-3xl text-center uppercase">Completo</p>
                <Zap className="w-6 h-6" style={{ color: '#F2C849' }} />
              </div>
            ...
            <div className="p-8 bg-gradient-to-b from-[#F2F2F2] to-white">
              <div className="text-center mb-6">
                <p className="text-gray-600 text-lg mb-2 font-semibold">Aula + 40 Modelos Bônus</p>
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                  <div className="text-center">
                    ...
                    <div className="flex items-baseline">
                      <span className="text-6xl md:text-7xl font-black" style={{ color: '#1C8C4D' }}>R$ {advancedPrice}</span>
                      <span className="text-2xl text-gray-500">,00</span>
                    </div>
                ...
                <div className="rounded-xl p-3 mb-4 border-2" style={{ background: 'rgba(242, 200, 73, 0.2)', borderColor: '#F2C849' }}>
                  <p className="text-base font-bold text-gray-800">
                    💰 Cada modelo sai por menos de R$ 2,50!
                  </p>
              ...
              <div className="mb-6 p-4 rounded-xl border-2" style={{ background: 'rgba(28, 140, 77, 0.08)', borderColor: 'rgba(28, 140, 77, 0.3)' }}>
                <p className="text-sm italic text-gray-700">&ldquo;Comprei o completo e não me arrependo! Os modelos de sondagem e ficha já me salvaram várias vezes.&rdquo;</p>
              ...
              >
                ...
                <span>QUERO O COMPLETO AGORA!</span>
              </a>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-md border-2" style={{ borderColor: 'rgba(29, 143, 242, 0.3)' }}>
              <p className="font-bold text-xl mb-2 text-gray-700">Plano de R$ {basicPrice}</p>
              <p className="text-gray-600">Apenas a aula</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-2" style={{ borderColor: '#1C8C4D', background: 'linear-gradient(135deg, rgba(28, 140, 77, 0.08) 0%, #F2F2F2 100%)' }}>
              <p className="font-bold text-xl mb-2" style={{ color: '#1C8C4D' }}>Plano de R$ {advancedPrice}</p>
              <p className="font-semibold" style={{ color: '#1C8C4D' }}>Aula + 40 Modelos Bônus</p>
              <p className="text-4xl font-bold mt-2" style={{ color: '#1C8C4D' }}>41</p>
          ...
          <p className="text-lg text-gray-700 mt-6 font-medium">
            💡 Por apenas <span className="font-bold text-xl" style={{ color: '#1C8C4D' }}>R$ {ADVANCED_EXTRA} a mais</span>, você leva <span className="font-bold">40x mais conteúdo!</span>
          </p>
        </div>
      </div>
    </section>
