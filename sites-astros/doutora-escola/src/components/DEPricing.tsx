...
interface DEPricingProps {
  /** Preço da página (testes /v1, /v2...). Omitir = R$ 10. */
  price?: number
}
...
export function DEPricing({ price }: DEPricingProps) {
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-700 mt-6 font-medium">
            💡 Por apenas <span className="font-bold text-xl" style={{ color: '#1C8C4D' }}>R$ {ADVANCED_EXTRA} a mais</span>, você leva <span className="font-bold">5x mais conteúdo!</span>
          </p>
        </div>
      </div>
    </section>
