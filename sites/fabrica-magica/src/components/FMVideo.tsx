const VIDEO_EMBED_URL =
  'https://iframe.mediadelivery.net/embed/499108/7e882e37-9dd7-4ad0-ad60-1df0aacacf49?autoplay=false&loop=false&muted=false&preload=true&responsive=true'

export function FMVideo() {
  return (
    <section
      className="text-gray-900 py-16 md:py-20 relative overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #F2F2F2 0%, #ffffff 50%, rgba(29, 143, 242, 0.05) 100%)' }}
    >
      ...
      <div className="max-w-sm mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-gray-900">
            Veja a Fábrica Mágica funcionando ao vivo
          </h2>
          <p className="text-lg text-gray-700">
            Assista como uma professora cria um PDI completo em menos de 3 minutos
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <iframe
            ...
            allowFullScreen
            title="Vídeo demonstração Fábrica Mágica"
          />
          </div>
        </div>
        ...
        <div className="mt-6 text-center px-4 py-3 rounded-xl" style={{ background: 'rgba(242, 200, 73, 0.15)', border: '1px solid rgba(242, 200, 73, 0.4)' }}>
          <p className="text-sm font-medium text-gray-800">
            💡 Mais fácil que usar WhatsApp — se você sabe digitar, sabe usar a Fábrica Mágica
          </p>
        </div>
      </div>
    </section>
