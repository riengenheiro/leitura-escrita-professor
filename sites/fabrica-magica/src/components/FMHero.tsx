...
import { FMCountdown } from './FMCountdown'
import { FMSocialProof } from './FMSocialProof'
...
export function FMHero() {
  return (
    <>
      <FMCountdown />
      <FMSocialProof />
      {/* Hero Principal — quente e acolhedor para professoras */}
      <section
      ...
      >
        {/* Formas de fundo com a paleta — dão profundidade */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-sm">
                ...
                >
                  <OptimizedImage
                    src={`${import.meta.env.BASE_URL}images/fabrica-magica/hero-fm.webp`}
      ...
      {/* Faixa de dados — gradiente azul → verde, números em destaque */}
      <section
