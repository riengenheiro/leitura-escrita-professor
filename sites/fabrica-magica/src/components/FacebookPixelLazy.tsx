 ...
 * Meta recomenda enviar em todo evento para melhorar a pontuação de qualidade.
 */
...
export function FacebookPixelLazy({
  ...
  useEffect(() => {
    ...
    if (typeof window.fbq !== 'undefined' && 'loaded' in window.fbq && (window.fbq as { loaded: boolean }).loaded) {
      setIsLoaded(true);
      if (autoPageView) {
    ...
    // Snippet oficial do Facebook: cria fbq + queue e carrega fbevents.js
    if (typeof window.fbq === 'undefined') {
      const stub = document.createElement('script');
      stub.textContent = `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');`;
      document.head.appendChild(stub);
      // Chamadas enfileiradas; fbevents.js processa ao carregar (assert: stub define fbq de forma síncrona)
      const fbq = (window as Window & { fbq: (a: string, b?: string, c?: unknown) => void }).fbq;
      fbq('init', pixelId);
      if (autoPageView) {
        fbq('track', 'PageView', getPageViewParams());
      }
      setIsLoaded(true);
      return () => {
