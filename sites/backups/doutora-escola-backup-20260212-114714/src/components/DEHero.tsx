...
export function DEHero() {
  return (
    <>
      {/* Faixa vermelha – Timer Countdown */}
      ...
      {/* Hero principal – texto + capa do livro */}
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-2xl md:text-3xl font-bold text-red-600 mb-6">Você não está sozinha!</p>
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                Mais de <strong>2.000 professoras</strong> já transformaram suas aulas com este guia prático, direto e totalmente alinhado à BNCC.
              </p>
            </div>
      ...
      {/* Faixa cinza – preço + CTA */}
      <section className="bg-gray-100 text-black py-12">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-2xl md:text-3xl font-bold mb-3">
            Livro Digital de <span className="line-through text-gray-500">R$ 47,00</span>{' '}
            por apenas <span className="text-green-600 text-3xl md:text-4xl">R$ 10,00</span>
          </p>
          <p className="text-lg md:text-xl text-gray-600 mb-8">Só para as <strong>100 primeiras</strong> professoras.</p>
          <a
            href="#opcoes"
