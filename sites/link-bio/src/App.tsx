    ...
    <main className="min-h-screen w-full bg-slate-100">
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 py-8 pb-20">
        ...
        <div className="space-y-4 mt-6">
          ...
          <LinkCard
            href="https://guiapratico.doutoraescola.com.br"
            icon={<GraduationCap className="w-6 h-6" />}
            title="Guia Prático – Dificuldades Escolares"
            subtitle="Identifique e atue nas dificuldades de aprendizagem"
            variant="default"
          />
          <LinkCard
            href="https://codigos.doutoraescola.com.br"
            icon={<Hash className="w-6 h-6" />}
            title="Códigos BNCC (Alfanuméricos)"
            subtitle="Guia completo dos códigos da BNCC"
            variant="default"
          />
          <LinkCard
            href="https://atividadesludicas.doutoraescola.com.br"
            icon={<Palette className="w-6 h-6" />}
            title="Atividades Lúdicas – Alfabetização"
            subtitle="Atividades para alfabetização"
            variant="default"
          />
          <LinkCard
            href="https://clube.doutoraescola.com.br"
            icon={<Crown className="w-6 h-6" />}
            title="Clube Doutora Escola"
            subtitle="Conteúdos e materiais por assinatura"
            variant="default"
          />
          <LinkCard
            href="https://relatorioconstrutivista.doutoraescola.com.br"
            icon={<FileText className="w-6 h-6" />}
            title="Relatórios Construtivistas (TEA)"
            subtitle="Relatórios para alunos com TEA"
            variant="default"
          />
          <LinkCard
            href="https://planejamento.doutoraescola.com.br"
            icon={<Calendar className="w-6 h-6" />}
            title="Planejamento Anual BNCC"
            subtitle="Planejamento alinhado à BNCC"
            variant="default"
          />
          <LinkCard
            href="https://presente.doutoraescola.com.br"
            icon={<MapPin className="w-6 h-6" />}
            title="Roteiro Para Relatórios (Presente)"
            subtitle="Roteiro para elaboração de relatórios"
            variant="default"
          />
          <LinkCard
            href="https://ideias.doutoraescola.com.br"
            icon={<Lightbulb className="w-6 h-6" />}
            title="Doutora Escola – Ideias"
            subtitle="Ideias e conteúdos Doutora Escola"
            variant="default"
          />
          <LinkCard
            href="https://protocolo.vivasuamissao.top"
            icon={<Zap className="w-6 h-6" />}
            title="Protocolo Energia Total"
            subtitle="Viva Sua Missão"
            variant="default"
          />
        </div>
