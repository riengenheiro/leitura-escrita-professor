      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-gray-100">
              <OptimizedImage
                src="/images/atividades-ludicas/07-quem-sou-eu.png"
