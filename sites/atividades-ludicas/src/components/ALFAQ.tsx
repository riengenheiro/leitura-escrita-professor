const faqs = [
  { q: 'Para quem e esse produto?', a: 'Qualquer pessoa que sabe a importancia de usar atividade ludicas para alfabetizar, mesmo que comecando do zero.' },
  { q: 'Tenho uma garantia?', a: 'Sim! Garantia total de 7 dias.' },
  { q: 'Mesmo comecando do Zero esse produto serve para mim?', a: 'Sim, ele traz ideias que voce pode implementar no mesmo dia!' },
  { q: 'Formas de pagamento?', a: 'Pix, cartao de credito, boleto!' },
]

export function ALFAQ() {
  return (
